...
const chartLayout = {
    ...
    margin    : { t: 0, r: 0 },     // Отступы от самой сетки графика сверху и справа (иначе будет пустое место на странице)
    ...
    yaxis: {
        title: {
            ...
            standoff: 20,                         // Отступ от оси Y до подписи (иначе текст может прилипать к оси)
        },
    ...
    legend: {
        ...
        y: isMobile ? -0.6 : 1.2,           // Позиционирует легенду выше или ниже относительно графика (1.2 => значит на 20% выше графика) (иначе может перекрывать ось X)
